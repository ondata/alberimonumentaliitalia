...
- mappa su uMap o su Carto;
- file CSV e JSON unico con i dati grezzi, solo unione senza alcuna pulizia;
- scrivere che nel file di output ho aggiunto
    - coordinate pulite;
    - procom
    - nome del file di origine
    - trasformato in array CRITERI DI MONUMENTALITA', con `|` come separatore